...
/// <summary>
/// Selects user_name from schema_with_foreign_keys.users, skipping 9223372036854775807
/// rows and taking 1.
/// </summary>
public sealed record SkipBeyondIntMaxQuery
{
    ...
    public Query Value =>
        new Query(
            ...
            having: null,
            orderBy: null,
            new ModelPagination(long.MaxValue, 1)
        );
