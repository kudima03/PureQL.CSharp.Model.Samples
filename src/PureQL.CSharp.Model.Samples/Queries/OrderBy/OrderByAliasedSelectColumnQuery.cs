...
/// <summary>
/// Selects order_total as grandTotal from schema_with_foreign_keys.orders, ordered by
/// order_total.
/// </summary>
public sealed record OrderByAliasedSelectColumnQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("grandTotal"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
