...
/// <summary>
/// Selects order_status and placed_on from schema_with_foreign_keys.orders, ordered by
/// order_status and placed_on.
/// </summary>
public sealed record OrderByStatusAscThenPlacedOnAscQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new OrderStatusColumn(), new PlacedOnColumn()],
                []
            ),
            [
                new Row(
