...
/// <summary>
/// Selects order_status from schema_with_foreign_keys.orders, filtered by '12:00:00'
/// equals '12:00:00'.
/// </summary>
public sealed record ScalarTimeEqualityOfEqualConstantsQuery
{
            ...
            new BooleanReturning(
                new Equality(
                    new SingleValueEquality(
                        new TimeEquality(
                            new TimeReturning(new TimeScalar(new TimeOnly(12, 0, 0))),
                            new TimeReturning(new TimeScalar(new TimeOnly(12, 0, 0)))
                        )
                    )
                )
