...
/// the rows where users.user_active equals false or the days between orders.placed_on and
/// users.signup_date is greater than 1500.
/// </summary>
public sealed record EachOrOfJoinedBooleanEqualityAndCrossEntityDateDiffComparisonQuery
{
