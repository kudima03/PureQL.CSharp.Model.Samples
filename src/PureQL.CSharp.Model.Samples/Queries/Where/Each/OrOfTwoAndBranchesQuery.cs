...
/// (order_status equals 'shipped' and order_total is at least 200) or (order_status
/// equals 'pending' and order_total is less than 100).
/// </summary>
public sealed record OrOfTwoAndBranchesQuery
{
