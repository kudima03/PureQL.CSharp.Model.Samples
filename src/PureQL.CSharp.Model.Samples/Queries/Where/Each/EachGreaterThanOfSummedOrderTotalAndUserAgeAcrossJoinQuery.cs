...
/// the rows where (orders.order_total plus users.user_age) is greater than 120.
/// </summary>
public sealed record EachGreaterThanOfSummedOrderTotalAndUserAgeAcrossJoinQuery
{
