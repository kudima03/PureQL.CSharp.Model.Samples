...
/// <summary>
/// Selects order_id from schema_with_foreign_keys.orders, filtered by the whole placed_at
/// column equals a list of 6 datetimes.
/// </summary>
public sealed record WholeDateTimeArrayEqualityOfFieldAgainstLiteralQuery
{
