...
/// <summary>
/// Selects users.user_name from schema_with_foreign_keys.users, full-joined to
/// schema_with_foreign_keys.products on false.
/// </summary>
public sealed record FullJoinOnConstantFalseQuery
{
