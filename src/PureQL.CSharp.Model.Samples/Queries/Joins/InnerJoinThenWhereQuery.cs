...
/// <summary>
/// Selects users.user_name from schema_with_foreign_keys.orders, inner-joined to
/// schema_with_foreign_keys.users on orders.order_user_id equals users.user_id, keeping
/// the rows where orders.order_total is greater than 100.
/// </summary>
public sealed record InnerJoinThenWhereQuery
{
