...
/// right-joined to schema_with_foreign_keys.users on orders.order_user_id equals
/// users.user_id, ordered by orders.order_total and users.user_name, skipping 2 rows and
/// taking 3.
/// </summary>
public sealed record RightJoinOrderByThenPaginationQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new UserNameColumn(), new OrderTotalColumn()],
                []
            ),
            [
                new Row(
