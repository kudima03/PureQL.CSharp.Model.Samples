...
/// left-joined to schema_with_foreign_keys.orders on users.user_id equals
/// orders.order_user_id, ordered by orders.order_total and users.user_name.
/// </summary>
public sealed record LeftJoinOrderByJoinedTotalAscendingQuery
{
