    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                ...
                [
                    new UserAgeColumn(),
                    new Column(new String("meanTotalPlusAge"), new DoubleColumnType()),
                ],
                []
            ),
            [
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                new Column(
                                    new String("meanTotalPlusAge"),
                                    new DoubleColumnType()
                                ),
                                new InvariantCell(new Double(225))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(161.4375))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(142.5))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
