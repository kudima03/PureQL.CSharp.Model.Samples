...
/// <summary>
/// Selects the maximum of (orders.order_total divided by users.user_score) as maxRatio
...
/// </summary>
public sealed record MaxOfEachDivideWholeSetQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("maxRatio"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
