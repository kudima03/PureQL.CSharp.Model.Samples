...
/// <summary>
/// Selects the average of (orders.order_total minus users.user_age) as meanDiff from
/// schema_with_foreign_keys.orders, inner-joined to schema_with_foreign_keys.users on
/// orders.order_user_id equals users.user_id.
/// </summary>
public sealed record WholeSetAverageOfEachSubtractQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("meanDiff"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(106.54166666666667))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
