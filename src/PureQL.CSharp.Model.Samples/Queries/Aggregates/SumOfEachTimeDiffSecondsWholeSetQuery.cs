...
/// <summary>
/// Selects the sum of the seconds between shift_start and '08:00:00' as totalGapSeconds
/// from schema_with_foreign_keys.users.
/// </summary>
public sealed record SumOfEachTimeDiffSecondsWholeSetQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("totalGapSeconds"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
