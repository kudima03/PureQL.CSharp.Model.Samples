...
/// <summary>
/// Selects orders.order_user_id and the average of (order_items.item_qty times
/// products.product_price) as meanLineValue from schema_with_foreign_keys.orders,
...
/// </summary>
public sealed record AverageOfEachMultiplyGroupedByOrderUserIdQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("meanLineValue"), new DoubleColumnType()),
                ],
                []
            ),
            [
