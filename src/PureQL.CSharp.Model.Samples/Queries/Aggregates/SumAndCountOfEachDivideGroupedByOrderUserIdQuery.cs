        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("sumRatio"), new DoubleColumnType()),
                    new Column(new String("ratioCount"), new DoubleColumnType()),
                ],
                []
            ),
            [
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(5.016666666666667))
                            ),
                            new KeyValuePair<IColumn, ICell>(
                                new Column(
                                    new String("ratioCount"),
                                    new DoubleColumnType()
                                ),
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(12.508333333333333))
                            ),
                            new KeyValuePair<IColumn, ICell>(
                                new Column(
                                    new String("ratioCount"),
