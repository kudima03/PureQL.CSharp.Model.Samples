        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("meanSpanDays"), new DoubleColumnType()),
                ],
                []
            ),
            [
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                new Column(
                                    new String("meanSpanDays"),
                                    new DoubleColumnType()
                                ),
                                new InvariantCell(new Double(1791))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(1089.5))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(1520.6666666666667))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
