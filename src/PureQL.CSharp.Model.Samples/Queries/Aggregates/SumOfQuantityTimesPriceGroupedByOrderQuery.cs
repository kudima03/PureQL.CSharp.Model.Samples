...
/// <summary>
/// Selects order_items.item_order_id and the sum of (order_items.item_qty times
/// products.product_price) as revenue from schema_with_foreign_keys.order_items,
