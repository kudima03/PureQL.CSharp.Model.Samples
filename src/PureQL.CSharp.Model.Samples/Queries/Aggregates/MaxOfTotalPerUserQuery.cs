...
/// <summary>
/// Selects the maximum of order_total as max_total from schema_with_foreign_keys.orders,
/// grouped by order_user_id.
/// </summary>
public sealed record MaxOfTotalPerUserQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("max_total"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
