...
/// <summary>
/// Selects orders.order_status and the count of (orders.order_total minus users.user_age)
/// as diffCount from schema_with_foreign_keys.orders, inner-joined to
/// schema_with_foreign_keys.users on orders.order_user_id equals users.user_id, grouped
/// by orders.order_status.
/// </summary>
public sealed record CountOfEachSubtractGroupedByOrderStatusQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("diffCount"), new DoubleColumnType()),
                ],
                []
            ),
            [
