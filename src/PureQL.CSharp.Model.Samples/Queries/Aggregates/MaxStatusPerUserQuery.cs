...
/// <summary>
/// Selects the maximum of order_status as max_status from
/// schema_with_foreign_keys.orders, grouped by order_user_id.
/// </summary>
public sealed record MaxStatusPerUserQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("max_status"), new StringColumnType())],
                []
            ),
            [
                new Row(
