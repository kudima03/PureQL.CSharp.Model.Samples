...
/// <summary>
/// Selects users.user_id and the maximum of the days between orders.placed_on and
/// users.signup_date as maxSpanDays from schema_with_foreign_keys.users, inner-joined to
/// schema_with_foreign_keys.orders on users.user_id equals orders.order_user_id, grouped
/// by users.user_id.
/// </summary>
public sealed record MaxOfEachDateDiffDaysQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                ...
                [
                    new UserIdColumn(),
                    new Column(new String("maxSpanDays"), new DoubleColumnType()),
                ],
                []
            ),
            [
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                new Column(
                                    new String("maxSpanDays"),
                                    new DoubleColumnType()
                                ),
                                new InvariantCell(new Double(1600))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(1171))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(579))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                    ...
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                ...
                                new InvariantCell(new Double(1792))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
