...
/// <summary>
/// Selects orders.order_user_id and the count of (order_items.item_qty times
/// products.product_price) as lineCount from schema_with_foreign_keys.orders,
...
/// </summary>
public sealed record CountOfEachMultiplyGroupedByOrderUserIdQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("lineCount"), new DoubleColumnType()),
                ],
                []
            ),
            [
