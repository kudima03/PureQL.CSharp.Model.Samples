...
/// <summary>
/// Selects order_id, order_status and order_total from schema_with_foreign_keys.orders.
/// </summary>
public sealed record SelectUuidStringAndDoubleColumnsTogetherFromOrdersQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new OrderIdColumn(), new OrderStatusColumn(), new OrderTotalColumn()],
                []
            ),
            [
                new Row(
