...
/// <summary>
/// Selects order_status and order_total from schema_with_foreign_keys.orders.
/// </summary>
public sealed record SelectMultipleColumnsQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new OrderStatusColumn(), new OrderTotalColumn()],
                []
            ),
            [
                new Row(
