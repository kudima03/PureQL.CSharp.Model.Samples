...
/// <summary>
/// Selects order_status, order_id and order_total from schema_with_foreign_keys.orders.
/// </summary>
public sealed record SelectOrderColumnsOutOfDeclaredOrderQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new OrderStatusColumn(), new OrderIdColumn(), new OrderTotalColumn()],
                []
            ),
            [
                new Row(
