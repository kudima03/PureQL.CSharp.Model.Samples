...
/// <summary>
/// Selects user_age, user_id and user_active from schema_with_foreign_keys.users.
/// </summary>
public sealed record SelectUserColumnsOutOfDeclaredOrderQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new UserAgeColumn(), new UserIdColumn(), new UserActiveColumn()],
                []
            ),
            [
                new Row(
