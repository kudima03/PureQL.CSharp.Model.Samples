...
/// <summary>
/// Selects the distinct rows of order_status from schema_with_foreign_keys.orders,
/// ordered by order_status, skipping 0 rows and taking 2.
/// </summary>
public sealed record DistinctWithPaginationQuery
{
