...
/// <summary>
/// Selects order_status and order_status as status_alias from
/// schema_with_foreign_keys.orders.
/// </summary>
public sealed record DuplicateFieldOnceBareOnceAliasedQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("status_alias"), new StringColumnType()),
                ],
                []
            ),
            [
