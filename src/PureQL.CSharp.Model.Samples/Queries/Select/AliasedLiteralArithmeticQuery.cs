...
/// <summary>
/// Selects 1 plus 2 as sum from schema_with_foreign_keys.users.
/// </summary>
public sealed record AliasedLiteralArithmeticQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("sum"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
