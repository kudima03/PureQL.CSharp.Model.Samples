...
/// keeping the groups where the maximum of shift_start equals '11:30:00'.
/// </summary>
public sealed record HavingMaxShiftStartEqualExistingValueQuery
{
                ...
                new Equality(
                    new SingleValueEquality(
                        new TimeEquality(
                            ...
                            new TimeReturning(new TimeScalar(new TimeOnly(11, 30, 0)))
                        )
                    )
                )
            ),
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(new EmptyString(), [new UserActiveColumn()], []),
            [
                new Row(
