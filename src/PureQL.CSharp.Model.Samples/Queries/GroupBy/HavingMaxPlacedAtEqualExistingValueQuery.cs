...
/// keeping the groups where the maximum of placed_at equals '2024-06-05T14:00:00'.
/// </summary>
public sealed record HavingMaxPlacedAtEqualExistingValueQuery
{
                ...
                new Equality(
                    new SingleValueEquality(
                        new DateTimeEquality(
                            ...
                            new DateTimeReturning(
                                new DateTimeScalar(new DateTime(2024, 6, 5, 14, 0, 0))
                            )
                        )
                    )
                )
