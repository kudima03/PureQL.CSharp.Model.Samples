...
/// keeping the groups where the maximum of placed_at is at most '2024-06-03T12:00:00'.
/// </summary>
public sealed record HavingMaxPlacedAtLessThanOrEqualConstantQuery
{
            ...
            new BooleanReturning(
                new Comparison(
                    new DateTimeComparison(
                        ...
                        new DateTimeReturning(
                            new DateTimeScalar(new DateTime(2024, 6, 3, 12, 0, 0))
                        )
                    )
                )
            ),
