...
/// keeping the groups where the maximum of placed_on is less than '2024-06-01'.
/// </summary>
public sealed record HavingMaxPlacedOnLessThanConstantQuery
{
            ...
            new BooleanReturning(
                new Comparison(
                    new DateComparison(
                        ...
                        new DateReturning(new DateScalar(new DateOnly(2024, 6, 1)))
                    )
                )
            ),
            orderBy: null,
