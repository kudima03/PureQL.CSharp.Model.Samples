...
/// <summary>
/// Selects orders.order_total and the sum of users.user_age as ageSum from
/// schema_with_foreign_keys.users, left-joined to schema_with_foreign_keys.orders on
/// users.user_id equals orders.order_user_id, grouped by orders.order_total.
/// </summary>
public sealed record LeftJoinGroupByJoinedTotalKeyQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("ageSum"), new DoubleColumnType()),
                ],
                []
            ),
            [
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                new Column(new String("ageSum"), new DoubleColumnType()),
                                new InvariantCell(new Double(53))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
                ...
                new Row(
                    new Dictionary<KeyValuePair<IColumn, ICell>, IColumn, ICell>(
                        [
                            ...
                            new KeyValuePair<IColumn, ICell>(
                                new Column(new String("ageSum"), new DoubleColumnType()),
                                new InvariantCell(new Double(72))
                            ),
                        ],
                        pair => pair.Key,
                        pair => pair.Value,
