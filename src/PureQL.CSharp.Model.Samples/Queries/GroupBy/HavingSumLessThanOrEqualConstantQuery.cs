...
/// keeping the groups where the sum of order_total is at most 150.5.
/// </summary>
public sealed record HavingSumLessThanOrEqualConstantQuery
{
            ...
            new BooleanReturning(
                new Comparison(
                    new NumberComparison(
                        ...
                        new NumberReturning(new NumberScalar(150.5))
                    )
                )
            ),
            orderBy: null,
