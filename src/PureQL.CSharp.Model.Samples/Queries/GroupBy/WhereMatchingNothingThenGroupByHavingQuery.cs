...
/// order_status equals 'no-such-status', grouped by order_status, keeping the groups
/// where the count of order_id is greater than 0.
/// </summary>
public sealed record WhereMatchingNothingThenGroupByHavingQuery
{
