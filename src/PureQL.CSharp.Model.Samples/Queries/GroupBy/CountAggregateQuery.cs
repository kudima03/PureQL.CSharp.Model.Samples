...
/// <summary>
/// Selects the count of order_id as group_count from schema_with_foreign_keys.orders,
...
public sealed record CountAggregateQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("group_count"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
