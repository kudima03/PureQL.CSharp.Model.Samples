...
/// <summary>
/// Selects the count of orders.order_status as status_count from
...
/// </summary>
public sealed record LeftJoinCountOfStringColumnQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("status_count"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
