...
/// <summary>
/// Selects the count of orders.order_total as total_count from
...
/// </summary>
public sealed record LeftJoinCountOfNumericColumnQuery
{
    ...
    public IStoredTableDataSet Result =>
        new StoredTableDataSet(
            new Table(
                new EmptyString(),
                [new Column(new String("total_count"), new DoubleColumnType())],
                []
            ),
            [
                new Row(
