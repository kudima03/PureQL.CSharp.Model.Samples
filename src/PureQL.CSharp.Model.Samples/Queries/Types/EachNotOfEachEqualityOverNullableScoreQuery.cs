...
/// <summary>
/// Selects user_name from schema_with_foreign_keys.users, keeping the rows where not
/// (user_score equals 30).
/// </summary>
public sealed record EachNotOfEachEqualityOverNullableScoreQuery
{
