...
/// <summary>
/// Selects order_user_id from schema_with_foreign_keys.orders, keeping the rows where not
/// (order_status equals 'cancelled'), grouped by order_user_id.
/// </summary>
public sealed record UsersWithNonCancelledOrdersQuery
{
