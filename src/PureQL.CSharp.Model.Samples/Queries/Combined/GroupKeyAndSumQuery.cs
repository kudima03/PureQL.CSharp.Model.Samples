...
/// <summary>
/// Selects order_user_id and the sum of order_total as userTotal from
/// schema_with_foreign_keys.orders, grouped by order_user_id.
/// </summary>
public sealed record GroupKeyAndSumQuery
{
        ...
        new StoredTableDataSet(
            new Table(
                ...
                [
                    ...
                    new Column(new String("userTotal"), new DoubleColumnType()),
                ],
                []
            ),
            [
