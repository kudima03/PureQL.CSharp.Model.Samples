...
public sealed record SumOfEachMultiplyGroupedByOrderUserIdQueryTests
{
    [Fact]
    public void ValueSerializesToExpectedJson()
    {
        Assert.Equal(
            ...
            new QueryJson(
                new SumOfEachMultiplyGroupedByOrderUserIdQuery().Value
            ).TextValue
        );
    }
    ...
    public void ResultMatchesExpectedRows()
    {
        Assert.Equal(
            ...
            new DataSetJson(
                new SumOfEachMultiplyGroupedByOrderUserIdQuery().Result
            ).TextValue
        );
    }
}
