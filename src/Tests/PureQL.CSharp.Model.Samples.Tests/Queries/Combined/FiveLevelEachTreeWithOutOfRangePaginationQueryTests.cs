...
public sealed record FiveLevelEachTreeWithOutOfRangePaginationQueryTests
{
    [Fact]
    public void ValueSerializesToExpectedJson()
    {
        Assert.Equal(
            ...
            new QueryJson(
                new FiveLevelEachTreeWithOutOfRangePaginationQuery().Value
            ).TextValue
        );
    }
    ...
    public void ResultMatchesExpectedRows()
    {
        Assert.Equal(
            ...
            new DataSetJson(
                new FiveLevelEachTreeWithOutOfRangePaginationQuery().Result
            ).TextValue
        );
    }
}
