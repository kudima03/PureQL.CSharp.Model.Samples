...
public sealed record WholeDateTimeArrayEqualityOfTwoEqualLiteralArraysQueryTests
{
    [Fact]
    public void ValueSerializesToExpectedJson()
    {
        Assert.Equal(
            ...
            new QueryJson(
                new WholeDateTimeArrayEqualityOfTwoEqualLiteralArraysQuery().Value
            ).TextValue
        );
    }
    ...
    public void ResultMatchesExpectedRows()
    {
        Assert.Equal(
            ...
            new DataSetJson(
                new WholeDateTimeArrayEqualityOfTwoEqualLiteralArraysQuery().Result
            ).TextValue
        );
    }
}
