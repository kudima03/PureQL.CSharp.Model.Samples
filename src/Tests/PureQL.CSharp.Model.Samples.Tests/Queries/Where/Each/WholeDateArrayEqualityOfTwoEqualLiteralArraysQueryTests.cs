...
public sealed record WholeDateArrayEqualityOfTwoEqualLiteralArraysQueryTests
{
    [Fact]
    public void ValueSerializesToExpectedJson()
    {
        Assert.Equal(
            ...
            new QueryJson(
                new WholeDateArrayEqualityOfTwoEqualLiteralArraysQuery().Value
            ).TextValue
        );
    }
    ...
    public void ResultMatchesExpectedRows()
    {
        Assert.Equal(
            ...
            new DataSetJson(
                new WholeDateArrayEqualityOfTwoEqualLiteralArraysQuery().Result
            ).TextValue
        );
    }
}
